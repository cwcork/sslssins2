...
/**
 * Test of PI/miCos Hydra controller with PRS110 rotary stage.
 * <p>
 * This stage has ncal and nrm limits; and has encoder index reference.
 *
 * @author cwcork
 */
public class PRS110HydraAxisTest
{
  // static fields
  private static final Logger logger = Logger.getLogger(PRS110HydraAxisTest.class.getName());
  ...
  public PRS110HydraAxisTest(String axisName,
                             HydraComm port,
                             int axisno,
                             double zeroOffset,
                             double lowerLimit,
  ...
  public static void main(String[] args)
  {
    ...
    double scale = 1.0;
    double offset = 0.0;
    double lowerLimit = -30.001;
    double upperLimit = +360.001;
    double midpoint = 0.0;
    ...
    try
    {
      ...
      test = new PRS110HydraAxisTest("/test/cxro/common/device/PRS110HydraAxis/" + axisName,
                                     comm,
                                     axisno,
                                     offset,
                                     lowerLimit,
      ...
      System.out.println("\tunits      = " + test.axis.getAxisUnits());
      ...
      // INITIALIZE AXIS - ncal, followed by refmove, then redefine zero
      ...
      //Move device to 2deg and then, -2deg
      ...
      System.out.println("  Moving to position: 2deg");
      ...
      System.out.println("  Current position: " + test.axis.getPosition() + test.axis.getAxisUnits() + " (Should be 2deg)");
      ...
      System.out.println("  Moving relative: +2deg");
      ...
      System.out.format("    Lower Limit Soft : %#f %n", test.axis.getLowerLimitSoft());
      System.out.format("    Lower Limit Hard : %#f %n", test.axis.getLowerLimitHard());
      System.out.println("  Move to absoluteRaw = 10.0");
      moveOp = test.axis.moveAbsoluteRaw(10.0);
      try
      {
        status = moveOp.get();
      }
  ...
  {
    System.out.println(
    "java -jar PRS110HydraAxisTest.jar "
