...
/**
 * Test Program for NUS.SINS2 Reflectometer MaskX stage default setup
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskXDefaultSetup
{
  private static final Logger logger = Logger.getLogger(MaskXDefaultSetup.class.getName());
  ...
  public MaskXDefaultSetup(String nodeName)
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskXDefaultSetup(nodeName);

      // Describe setup
      System.out.println("MaskXDefaultSetup:");
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskXDefaultSetup.jar "
    + "[<nodeName [String]>]");
  }
}
