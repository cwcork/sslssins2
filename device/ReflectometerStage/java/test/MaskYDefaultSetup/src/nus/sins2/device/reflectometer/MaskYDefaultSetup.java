...
/**
 * Test Program for NUS.SINS2 Reflectometer MaskY stage default setup
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskYDefaultSetup
{
  private static final Logger logger = Logger.getLogger(MaskYDefaultSetup.class.getName());
  ...
  public MaskYDefaultSetup(String nodeName)
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskYDefaultSetup(nodeName);

      // Describe setup
      System.out.println("MaskYDefaultSetup:");
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskYDefaultSetup.jar "
    + "[<nodeName [String]>]");
  }
}
