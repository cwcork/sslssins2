...
/**
 * Test Program for NUS.SINS2 FTR201 stage.
 * <p>
 * @author cwcork
 */
public class FilterStageTest
{
  private static final Logger logger = Logger.getLogger(FilterStageTest.class.getName());
  private static final String DEFAULT_NODENAME = "/test/nus/sins2/device/ftr201/stage";
  ...
  //
  //instance fields
  private FilterStage stage = null;
  private Axis axis = null;

  public FilterStageTest(String nodeName)
  throws IOException, InterruptedException
  {
    stage = new FilterStage(nodeName);
    axis = stage.getAxis();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new FilterStageTest(nodeName);
