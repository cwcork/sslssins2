...
/**
 * Test NUS.SINS2 MaskT axis within ReflectometerStage via Sins2Instruments helper.
 * NOTE: Units for stages are mm for linear and degree for angular.
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskTAxisTest
{
  private static final Logger logger = Logger.getLogger(MaskTAxisTest.class.getName());
  ...
  public MaskTAxisTest(String userDir)
  throws IOException, InterruptedException
  {
    this.instruments = new Sins2Instruments(userDir);
    this.axis = instruments.getMaskT();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskTAxisTest(System.getProperty("user.dir"));

      // Describe setup
      System.out.println("MaskTAxisTest:");
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskTAxisTest.jar ");
  }
}
