...
/**
 * Test NUS.SINS2 DetectorX axis within ReflectometerStage via Sins2Instruments helper.
 * NOTE: Units for stages are mm for linear and degree for angular.
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class DetectorXAxisTest
{
  private static final Logger logger = Logger.getLogger(DetectorXAxisTest.class.getName());
  ...
  public DetectorXAxisTest(String userDir)
  throws IOException, InterruptedException
  {
    this.instruments = new Sins2Instruments(userDir);
    this.axis = instruments.getDetectorX();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new DetectorXAxisTest(System.getProperty("user.dir"));

      // Describe setup
      System.out.println("DetectorXAxisTest:");
  ...
  {
    System.out.println(
    "USAGE: java -jar DetectorXAxisTest.jar ");
  }
}
