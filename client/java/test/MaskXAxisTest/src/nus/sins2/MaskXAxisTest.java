...
/**
 * Test NUS.SINS2 MaskX axis within ReflectometerStage via Sins2Instruments helper.
 * NOTE: Units for stages are mm for linear and degree for angular.
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskXAxisTest
{
  private static final Logger logger = Logger.getLogger(MaskXAxisTest.class.getName());
  ...
  public MaskXAxisTest(String userDir)
  throws IOException, InterruptedException
  {
    this.instruments = new Sins2Instruments(userDir);
    this.axis = instruments.getMaskX();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskXAxisTest(System.getProperty("user.dir"));

      // Describe setup
      System.out.println("MaskXAxisTest:");
      ...
      test.instruments.disconnect();
      test.axis = test.instruments.getMaskX();
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskXAxisTest.jar ");
  }
}
