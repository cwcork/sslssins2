...
/**
 * Test NUS.SINS2 MaskZ axis within ReflectometerStage via Sins2Instruments helper.
 * NOTE: Units for stages are mm for linear and degree for angular.
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskZAxisTest
{
  private static final Logger logger = Logger.getLogger(MaskZAxisTest.class.getName());
  ...
  public MaskZAxisTest(String userDir)
  throws IOException, InterruptedException
  {
    this.instruments = new Sins2Instruments(userDir);
    this.axis = instruments.getMaskZ();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskZAxisTest(System.getProperty("user.dir"));

      // Describe setup
      System.out.println("MaskZAxisTest:");
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskZAxisTest.jar ");
  }
}
