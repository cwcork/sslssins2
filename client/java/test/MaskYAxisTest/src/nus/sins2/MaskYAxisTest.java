...
/**
 * Test NUS.SINS2 MaskY axis within ReflectometerStage via Sins2Instruments helper.
 * NOTE: Units for stages are mm for linear and degree for angular.
 * <p>
 * @author Carl Cork &lt;cwcork@lbl.gov&gt;
 */
public class MaskYAxisTest
{
  private static final Logger logger = Logger.getLogger(MaskYAxisTest.class.getName());
  ...
  public MaskYAxisTest(String userDir)
  throws IOException, InterruptedException
  {
    this.instruments = new Sins2Instruments(userDir);
    this.axis = instruments.getMaskY();
  }
...
//    Logger.getLogger("").setLevel(Level.ALL); // ALL levels
    ...
    try
    {
      ...
      test = new MaskYAxisTest(System.getProperty("user.dir"));

      // Describe setup
      System.out.println("MaskYAxisTest:");
  ...
  {
    System.out.println(
    "USAGE: java -jar MaskYAxisTest.jar ");
  }
}
